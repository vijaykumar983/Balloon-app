...
public class Balloon extends AppCompatImageView implements Animator.AnimatorListener, ValueAnimator.AnimatorUpdateListener {
    ...
    public Balloon(Context context, int rawHeight ,BalloonListener mListener,int mBalloonImg) {
        super(context);

        this.mListener = mListener;

        this.setImageResource(R.drawable.balloon1);
        //this.setImageResource(mBalloonImg);
        //this.setColorFilter(R.color.purple_700);
